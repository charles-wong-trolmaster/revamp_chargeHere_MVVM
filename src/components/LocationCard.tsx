...
const LocationCard: React.FC<LocationCardProps> = ({
  ...
  const handleScroll = (event: React.UIEvent<HTMLDivElement>) => {
    ...
    if (isAtBottom && hasNextPage && !isFetching && onScrollToBottom) {
      onScrollToBottom();
    }
  ...
  return (
    <div
      className="uk-overflow-auto uk-padding-small"
      style={{
        height: "100%",
        paddingRight: "8px",
      }}
    ...
    >
          ...
          {items.map((location) => (
            <div key={location.id}>
              <button
                ...
                className="uk-button uk-button-default uk-width-1-1 uk-text-left uk-padding-small uk-border-rounded"
                style={{
              ...
              >
                <div className="uk-grid-small uk-flex-middle" uk-grid="">
                  <div className="uk-width-expand">
                    {/* Location Name */}
                    <span className="uk-margin-remove uk-text-bold uk-text-light">
                      {location.name}
                    </span>
      ...
      {isFetching && items.length > 0 && (
        <div className="uk-text-center uk-padding uk-text-light">
          ...
          <p className="uk-margin-small-top uk-text-small">{loadingMoreText}</p>
        </div>
      )}
