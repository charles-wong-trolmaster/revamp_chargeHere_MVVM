...
const Edit: React.FC<LocationSettingsContentProps> = ({
                  ...
                  watchedOpeningTimes.regular_hours.map((hour, index) => (
                    ...
                    >
                      <div className="uk-width-1-4">
                        <select
                          {...register(
                            `opening_times.regular_hours.${index}.weekday`
                          )}
                          onChange={(e) => {
                      ...
                      <div className="uk-width-1-4">
                        <input
                          {...register(
                            `opening_times.regular_hours.${index}.period_begin`
                          )}
                          type="text"
                      ...
                      <div className="uk-width-1-4">
                        <input
                          {...register(
                            `opening_times.regular_hours.${index}.period_end`
                          )}
                          type="text"
