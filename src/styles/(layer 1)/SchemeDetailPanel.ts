export const styles = {
    ...
    tierHeader: {
      display: "grid",
      gridTemplateColumns: "40px 1fr 1fr 1fr 1fr 1fr 50px", // Adjusted column sizes
      gap: "8px", // Reduced gap
      fontWeight: "bold",
    ...
    tierRow: {
      display: "grid",
      gridTemplateColumns: "40px 1fr 1fr 1fr 1fr 1fr 50px", // Match header
      gap: "8px", // Reduced gap
      alignItems: "center",
      padding: "8px 0",
    ...
    tierInput: {
      ...
      minWidth: "60px", // Minimum input width
    },
    tierInputDisabled: {
      padding: "4px 6px",
      borderRadius: "4px",
    ...
    rateTypeButtonInactiveDisabled: {
      padding: "8px 16px",
      border: "none",
      cursor: "not-allowed",
      transition: "all 0.2s ease",
